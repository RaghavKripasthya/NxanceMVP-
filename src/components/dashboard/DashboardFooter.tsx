...
export default function DashboardFooter() {
  return (
    <ScrollReveal delay={120}>
      <footer className="mt-2 border-t border-[#e2e8f0] bg-white">
          ...
          <div className="flex flex-col gap-10 lg:flex-row lg:items-start lg:justify-between lg:gap-16">
            <div className="max-w-md">
              ...
              <p className="mt-4 text-sm leading-relaxed text-[#64748b] sm:text-[15px]">
                Sophisticated AI-driven investment strategies for the modern wealth
                builder. Trade, track, and optimize with precision.
              </p>
            </div>
